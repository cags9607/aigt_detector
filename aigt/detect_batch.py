...
def detect_batch(
    ...
    *,
    ...
    hf_token: Optional[str] = "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", # This token is read-only, so no big problem for hard coding it inside this private repo
    # Inference knobs
    max_len: int = 500,
    batch_size: int = 16,
    progress: bool = True,
    ...
    model_name_fallback: str = "Qwen/Qwen2.5-3B-Instruct", # Kudos to Alibaba. Tested Llama and Mistral as well, obtaining worse results and not a full coverage of the languages of interest.
