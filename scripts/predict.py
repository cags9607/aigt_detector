...
def main():
    ...
    ap.add_argument("--token", default=None, help="HF token (or set HF_TOKEN / HUGGINGFACE_HUB_TOKEN env var)")
    ap.add_argument("--repo-id", default="Trinotrotolueno/aigt-loras")
